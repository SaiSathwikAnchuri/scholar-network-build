...
const LoginForm = () => {
  ...
  const quickLogins = [
    ...
    { email: 'sarah.johnson@gmail.com', password: 'alumni123', role: 'Alumni' },
    { email: 'mike.student@college.edu', password: 'student123', role: 'Student' },
  ];
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md space-y-6 p-4">
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-bold gradient-text">Alumni Portal</h1>
